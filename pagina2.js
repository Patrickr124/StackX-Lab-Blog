function svg() {
  ...
  if (svg === ".visualização1") {
    (svgtexto1.innerHTML =
      "<strong>A Arte da Programação</strong><br><br>" +
    ...
    (svgtexto2.innerHTML =
      "<strong>Desvendando a Inteligência Artificial</strong><br><br>" +
    ...
    (svgtexto3.innerHTML =
      "<strong>A Revolução da Tecnologia Médica</strong><br><br>" +
    ...
    (svgtexto4.innerHTML =
      "<strong>A Ascensão da Tecnologia Ambiental</strong><br><br>" +
...
function menu() {
  ...
  if (menu === ".link2") {
    sinopsePro.innerHTML =
      "Aprender a programar pode abrir novas oportunidades de carreira, de negócios e de lazer. Além disso, a programação pode ser divertida e gratificante, pois permite criar coisas incríveis com o poder da tecnologia.";
    ...
    sinopseIA.innerHTML =
      "IA pode trazer benefícios para a sociedade e para a economia, como melhorar a qualidade de vida das pessoas, aumentar a produtividade e a inovação das empresas e dos países, e resolver problemas complexos.";
    ...
    sinopseM.innerHTML =
      "tecnologia médica é a aplicação da ciência e da engenharia para melhorar a saúde e o bem-estar das pessoas. A tecnologia médica envolve o desenvolvimento, a produção e o uso de dispositivos, equipamentos, sistemas e softwares.";
    ...
    sinopseA.innerHTML =
      "Tecnologia ambiental é usar ciência e engenharia para proteger ou melhorar o meio ambiente. Ela cria e usa dispositivos, equipamentos, sistemas, softwares e serviços que evitam, diminuem ou eliminam a poluição e o desperdício.";
